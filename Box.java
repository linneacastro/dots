...
public class Box {
		...
		public Box() {          
		    whoOwnsThisBox=' '; // Init ownership to blank space
		    
			top=false; // Box edges are booleans init to false
			bottom=false;
			right=false;
			left=false;
		}
		...
		// if a line has already been drawn/is true, fore example.  Information about ownership can also be
		...
		// boolean comparision and replacing this with a single boolean value, true if all 4 edges are true.
